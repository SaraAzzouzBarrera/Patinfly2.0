...
import cat.urv.deim.asm.patinfly.databinding.ScooterLlogarBinding
...
class LlogarScooters : Fragment() {

    private var _binding: ScooterLlogarBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = ScooterLlogarBinding.inflate(inflater, container, false)
    ...
    fun databaseUpdateRecyclerViewWithCoroutines(context: Context, scooterDao: ScooterDao, adapter: ScooterRecyclerViewAdapter) {
        CoroutineScope(Dispatchers.Main).launch {
            val scooterDeferred: Deferred<List<Scooter>> =
                ScooterRepository.getScootersLlogats(context, scooterDao,"false")
